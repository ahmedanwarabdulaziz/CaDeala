...
import { PostgreSQLService, DatabaseCategory } from '@/lib/postgresql';
import { 
  ArrowLeftIcon,
  PhotoIcon,
  EyeIcon,
...
export default function EditCategoryPage() {
    ...
    try {
      ...
      if (categoryData) {
        ...
        setFormData({
          ...
          seoKeywords: categoryData.seo_keywords.join(', '),
          order: categoryData.order,
          isActive: categoryData.is_active,
          isFeatured: categoryData.is_featured
        });
        setImages({
          bannerImage: categoryData.banner_image || '',
          roundedImage: categoryData.rounded_image || '',
          squareImage: categoryData.square_image || '',
          cardImage: categoryData.card_image || ''
        });
      } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await PostgreSQLService.updateCategory(categoryId, categoryData);

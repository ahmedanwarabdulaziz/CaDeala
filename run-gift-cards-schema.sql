-- Run this in your Supabase SQL Editor to create the gift card tables
-- This fixes the foreign key constraint issue by using TEXT for customer_id to match users.id
...
-- Success message
SELECT 'Gift card tables created successfully! Foreign key constraints are now compatible with users.id (TEXT type).' as message;
